...
Production-ready Docker images for Asterisk PBX with advanced DRY template system, supporting 28 versions from 24.0.0-rc1 to 23.5.0 plus git development builds.
...
| **24.0.0-rc1** | `latest,stable,24` | Trixie | amd64, arm64 |
