...
Production-ready Docker images for Asterisk PBX with advanced DRY template system, supporting 23 versions from 1.2.40 to 23.2.0 plus git development builds.
